...
# dependency .debs from /prebuilt, then builds pairs_uav_testing and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_uav_testing/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_testing
